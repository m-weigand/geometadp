...
htmlhelp_basename = 'agrogeophy-metadata-doc'
numfig = True
...
latex_documents = [
    (master_doc, 'agrogeophy-metadata.tex', 'Agrogeophy-metadata Documentation',
     'agrogeophy', 'manual'),
]
...
man_pages = [
    (master_doc, 'Agrogeophy-metadata', 'Agrogeophy-metadata Documentation',
     [author], 1)
]
