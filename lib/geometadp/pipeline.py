...
class pipeline(object):
    ...
    def _create_project_button(self):
        # create a project
        title = widgets.HTML('''
            <h1 id="pipeline-for-reproducible-geophysical-experiment">Pipeline for reproducible geophysical experiment</h1>
            <p>This GUI is based on the Expipe package
            <a href="https://expipe.readthedocs.io/en/latest/">Expipe package</a> </p>
            <h4> Create a new project </h4>
            Create a new project will return a new folder (in the current working dir) containing 4 subfolders: action/entities/modules and templates
